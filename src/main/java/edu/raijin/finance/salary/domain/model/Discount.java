...
public class Discount {
    ...
    public void checkValidRegistration() {
        requirePositive(amount, () -> new BadRequestException("La cantidad a descontar es requerida"));
        requireNonBlank(reason, () -> new BadRequestException("La razón del descuento es requerida"));
    }

    public void updateFrom(Discount updated) {
